import 'package:core/src/component/atoms/gits_spacing.dart';
import 'package:core/src/component/molecules/gits_status_message.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (widget.title != null) const GitsSpacing.vertical8(),
        TextField(
