...
final class GitsColorLight extends GitsColors {
  static final GitsColorLight _instance = GitsColorLight._();

  factory GitsColorLight() {
    return _instance;
  }
  ...
  @override
  Color get primary => const Color(0xFF006778);
  @override
